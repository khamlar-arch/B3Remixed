...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var b3pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			['Faye',				'faye',			'Sprite Artist',					'https://twitter.com/JusttFaye', 			'91CDE9'],
			['NeatoNG',				'neato',		'Promotional Artist',				'https://twitter.com/neatochao', 			'F0AD38'],
			['Yabo',				'yabo',			'Sprite Artist',					'https://twitter.com/yaboigp',	 			'C60011'],
			['Deca',  				'deca',			'Sprite Artist',					'https://twitter.com/TheSculpturema1',		'F61F5D'],
			['Milla209NG',			'milla',		'Sprite Artist',					'https://twitter.com/Milla209NG', 			'000066'],
			['Bizarre_Ethen',		'ethen',		'Sprite Artist',					'https://twitter.com/BizarreEthen', 		'FFFFFF'],
			['EthanTheDoodler',		'ethan',		'Sprite Artist',					'https://twitter.com/D00dlerEthan', 		'555CD5'],
			['SugarRatio',			'sugar',		'Character Designer',				'https://twitter.com/SugarRatio', 			'CFCFCF'],
			['teethlust',			'teeth',		'Background/UI Artist',				'https://twitter.com/teethlust',			'FF0000'],
			['Latte',  				'latte',		'Icon + Promotional Artist',		'https://twitter.com/LatteBunss',			'271D1C'],
			['Mikefnf',				'mike',			'Background Artist',				'https://twitter.com/MikeFnf',				'F1E2D3'],
			['Little_Geecko',		'peepaw',		'Background Artist',				'https://twitter.com/Little_Geecko',		'FF8AB5'],
			['ShayReyez',  			'shay',			'Sprite Artist',					'https://twitter.com/ShayReyez', 			'FF00AA'],
			['Childish_Manga',		'biggie',		'Sprite Artist',					'https://twitter.com/VaChildish', 			'6E5787'],
			['Shellyn',				'shellyn',		'Background Artist',				'https://twitter.com/sh3llynn', 			'8A4FAE'],
			...
			['Programmers'],
			['TKTems',				'tk',			'Lead Programmer',					'https://twitter.com/TKTems',				'40D9BD'],
			...
			['TSG',					'tsg',			'Former Programmer',				'https://twitter.com/AyeTSG',				'FFFFFF'],
			['Cval',  				'cval',			'Former Programmer',				'https://twitter.com/cval_brown',			'3E5FFF'],
			...
			['Sunny',				'sunny',		'Charter',							'https://twitter.com/DuckierKarma',			'663333'],
			['snowy',				'snowy',		'Charter',							'https://twitter.com/neuroxrd', 			'009599'],
			['Special Thanks'],
			['BlazeTheWolf55',		'blaze',		'Original B3 Recolors',				'https://twitter.com/BlazeTheWolf10',		'FFAA00'],
			['FruityDaLei',			'lei',			'Emotional Support',				'https://twitter.com/FruityDaLei',			'CE3C40'],
